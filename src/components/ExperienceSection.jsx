...
const ITEMS = [
  ...
  { type: 'work', period: '2023 — 2024', role: 'Front-End Developer',  org: 'EKRILI · Algiers', desc: 'Developing and enhancing the startups web interface, focusing on responsive design, performance, and user experience.' },
...
function ExpEntry({ entry }) {
  ...
  /* once:false → re-animates on scroll up too */
  ...
  return (
    <div className="exp">
      <motion.div
        ...
        animate={headerInView ? { opacity: 1, y: 0, scale: 1 } : { opacity: 0, y: 24, scale: 0.88 }}
